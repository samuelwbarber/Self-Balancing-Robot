...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(19).translation = [0 1.1102230246251565e-15 0];  % mm
smiData.RigidTransform(19).angle = 0;  % rad
smiData.RigidTransform(19).axis = [0 0 0];
smiData.RigidTransform(19).ID = "AssemblyGround[rigid_body:1:Battery Module v16:1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(20).translation = [2.7533531010703882e-13 -72.000000000000142 -4.6629367034256575e-14];  % mm
smiData.RigidTransform(20).angle = 4.4408920985006301e-16;  % rad
smiData.RigidTransform(20).axis = [0 1 0];
smiData.RigidTransform(20).ID = "AssemblyGround[rigid_body:1:Logic Module v7:1:Chassis:1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(21).translation = [8.8817841970012523e-15 284.99999999999994 0];  % mm
smiData.RigidTransform(21).angle = 0;  % rad
smiData.RigidTransform(21).axis = [0 0 0];
smiData.RigidTransform(21).ID = "AssemblyGround[rigid_body:1:Logic Module v7:1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(22).translation = [132.82323856740004 6.5130570846542497 19.8025105567385];  % mm
smiData.RigidTransform(22).angle = 3.1415926535897927;  % rad
smiData.RigidTransform(22).axis = [-0.70710678118654757 1.8558743187999112e-16 0.70710678118654746];
smiData.RigidTransform(22).ID = "RootGround[wheel v1:1]";
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(9).mass = 0.68228159101559527;  % lbm
smiData.Solid(9).CoM = [9.2531639213805029e-07 43.307536287977591 0.00012119287106218965];  % mm
smiData.Solid(9).MoI = [1364.2992413603683 993.51106545533162 1364.2992704927285];  % lbm*mm^2
smiData.Solid(9).PoI = [-0.0041945668705003509 -1.1112140959149038e-05 -3.1982923312313582e-05];  % lbm*mm^2
smiData.Solid(9).color = [0.74901960784313726 0.74901960784313726 0.74901960784313726];
smiData.Solid(9).opacity = 1;
smiData.Solid(9).ID = "Chassis.ipt_{CB255870-4C81-5A40-A6C4-F1949B79EC0E}";
