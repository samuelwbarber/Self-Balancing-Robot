...
smiData.RigidTransform(1).translation = [0 0 27.800000000000004];  % mm
smiData.RigidTransform(1).angle = 1.5707963267948968;  % rad
smiData.RigidTransform(1).axis = [-6.1756155744774352e-16 -1 -6.1756155744774352e-16];
smiData.RigidTransform(1).ID = "B[wheels_assem:1:-:rigid_body:1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [0 39.600000000000001 0];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(3).translation = [20.000000000008011 7.9936057773011271e-14 -4.4408920985006262e-15];  % mm
smiData.RigidTransform(3).angle = 1.570796326794897;  % rad
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [-19.999999999994799 0 4.4408920985006262e-14];  % mm
smiData.RigidTransform(4).angle = 3.1415926535897931;  % rad
smiData.RigidTransform(4).axis = [0.70710678118654735 -0.70710678118654768 -1.6682232373514976e-16];
smiData.RigidTransform(4).ID = "AssemblyGround[rigid_body:1:Tilt Chassis:1:Stepper Motor v2:2]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [2.3092638912203256e-13 38.000000000000007 -40];  % mm
smiData.RigidTransform(5).angle = 2.2898349882893854e-16;  % rad
smiData.RigidTransform(5).axis = [1 0 0];
smiData.RigidTransform(5).ID = "AssemblyGround[rigid_body:1:Tilt Chassis:1:Spacer:1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(6).translation = [34.6410161513774 38.000000000000007 20.000000000000195];  % mm
smiData.RigidTransform(6).angle = 2.2898349882893854e-16;  % rad
smiData.RigidTransform(6).axis = [1 0 0];
smiData.RigidTransform(6).ID = "AssemblyGround[rigid_body:1:Tilt Chassis:1:Spacer:2]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(7).translation = [-34.641016151377706 38.000000000000007 19.999999999999805];  % mm
smiData.RigidTransform(7).angle = 2.2898349882893854e-16;  % rad
smiData.RigidTransform(7).axis = [1 0 0];
smiData.RigidTransform(7).ID = "AssemblyGround[rigid_body:1:Tilt Chassis:1:Spacer:3]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(8).translation = [0 2.2204460492503131e-15 0];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(9).translation = [0 2.2204460492503131e-15 0];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(10).translation = [2.3092638912203256e-13 74 -1.1102230246251565e-15];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(11).translation = [2.5757174171303632e-13 81 16.000000000000004];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(12).translation = [-0.99999999999974776 81 -15.999999999999996];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(13).translation = [2.4868995751603507e-13 74 -39.999999999999993];  % mm
smiData.RigidTransform(13).angle = 1.5707963267948968;  % rad
smiData.RigidTransform(13).axis = [1.1102230246251546e-16 1 -1.1102230246251546e-16];
smiData.RigidTransform(13).ID = "AssemblyGround[rigid_body:1:Battery Module v16:1:Battery Strut:1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(14).translation = [34.641016151377812 73.999999999999986 20];  % mm
smiData.RigidTransform(14).angle = 1.5707963267948968;  % rad
smiData.RigidTransform(14).axis = [1.1102230246251546e-16 1 -1.1102230246251546e-16];
smiData.RigidTransform(14).ID = "AssemblyGround[rigid_body:1:Battery Module v16:1:Battery Strut:2]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(15).translation = [-34.641016151377301 73.999999999999986 20];  % mm
smiData.RigidTransform(15).angle = 1.5707963267948968;  % rad
smiData.RigidTransform(15).axis = [1.1102230246251546e-16 1 -1.1102230246251546e-16];
smiData.RigidTransform(15).ID = "AssemblyGround[rigid_body:1:Battery Module v16:1:Battery Strut:3]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(16).translation = [2.3980817331903381e-13 239.09143954000001 0];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(17).translation = [0 2.2204460492503131e-15 0];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(18).translation = [2.7533531010703882e-13 -72.000000000000099 -4.1078251911130792e-14];  % mm
smiData.RigidTransform(18).angle = 4.4408920985006301e-16;  % rad
smiData.RigidTransform(18).axis = [0 1 0];
smiData.RigidTransform(18).ID = "AssemblyGround[rigid_body:1:Logic Module v7:1:Chassis:1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(19).translation = [0 285 4.4408920985006262e-15];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(20).translation = [132.82323856740004 6.5130570846542497 19.8025105567385];  % mm
smiData.RigidTransform(20).angle = 3.1415926535897927;  % rad
smiData.RigidTransform(20).axis = [-0.70710678118654757 1.8558743187999112e-16 0.70710678118654746];
smiData.RigidTransform(20).ID = "AssemblyGround[wheels_assem:1:wheel v1:1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(21).translation = [-41.976761432602778 6.5130570846542941 19.802510556738561];  % mm
smiData.RigidTransform(21).angle = 1.7391544425216394;  % rad
...
smiData.RigidTransform(22).ID = "RootGround[wheels_assem:1]";
...
smiData.RevoluteJoint(1).Rz.Pos = 173.27384555082094;  % deg
