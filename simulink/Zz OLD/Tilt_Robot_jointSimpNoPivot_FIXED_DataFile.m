...
smiData.RigidTransform(1).translation = [105.02323856740006 6.5130570846542843 19.8025105567385];  % mm
smiData.RigidTransform(1).angle = 2.0943951023931948;  % rad
smiData.RigidTransform(1).axis = [-0.57735026918962629 -0.57735026918962551 0.57735026918962551];
smiData.RigidTransform(1).ID = "B[wheels_assem:1:-:rigid_body:1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [59.600000000007952 -3.0264723961754663e-14 1.3853550643211955e-14];  % mm
smiData.RigidTransform(2).angle = 2.0943951023931948;  % rad
smiData.RigidTransform(2).axis = [-0.57735026918962629 -0.57735026918962562 0.57735026918962551];
...
smiData.RigidTransform(3).angle = 1.5707963267948974;  % rad
...
smiData.RigidTransform(4).axis = [0.70710678118654724 -0.70710678118654779 -1.6682232373514978e-16];
smiData.RigidTransform(4).ID = "AssemblyGround[rigid_body:1:Tilt Chassis:1:Stepper Motor v2:2]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [2.3092638912203256e-13 37.999999999999986 -40];  % mm
smiData.RigidTransform(5).angle = 2.1857515797307769e-16;  % rad
...
smiData.RigidTransform(6).angle = 2.1857515797307769e-16;  % rad
smiData.RigidTransform(6).axis = [1 0 0];
smiData.RigidTransform(6).ID = "AssemblyGround[rigid_body:1:Tilt Chassis:1:Spacer:2]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(7).translation = [-34.641016151377698 38 19.999999999999794];  % mm
smiData.RigidTransform(7).angle = 2.1857515797307769e-16;  % rad
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(10).translation = [2.3980817331903381e-13 74.000000000000028 0];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(11).translation = [2.3980817331903381e-13 81 16];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(12).translation = [-0.99999999999975664 81 -15.999999999999998];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(13).translation = [2.3092638912203256e-13 74 -40];  % mm
smiData.RigidTransform(13).angle = 1.5707963267948968;  % rad
smiData.RigidTransform(13).axis = [1.1102230246251548e-16 1 -1.1102230246251548e-16];
...
smiData.RigidTransform(14).axis = [1.1102230246251548e-16 1 -1.1102230246251548e-16];
smiData.RigidTransform(14).ID = "AssemblyGround[rigid_body:1:Battery Module v16:1:Battery Strut:2]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(15).translation = [-34.641016151377301 74 20];  % mm
smiData.RigidTransform(15).angle = 1.5707963267948968;  % rad
smiData.RigidTransform(15).axis = [1.1102230246251548e-16 1 -1.1102230246251548e-16];
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(18).translation = [2.7533531010703882e-13 -72.000000000000099 -3.9968028886505635e-14];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(19).translation = [0 284.99999999999994 0];  % mm
...
smiData.RevoluteJoint(1).Rz.Pos = 2.8794448376461084;  % deg
